...
class RecurringPurchaseConfigTest {
  ...
  fun `should return tomorrow at noon for daily frequency`() {
    ...
    classUnderTest.nextDepositZonedDateTime shouldEqual LocalDate.of(1970, JANUARY, 2).atStartOfDay(ZoneOffset.UTC)
  }
  ...
  fun `next deposit day`(frequency: Frequency, day: Int, now: LocalDate, expected: ZonedDateTime) {
    ...
    classUnderTest.nextDepositZonedDateTime shouldEqual expected
  }
  ...
  fun `should get the correct number of milliseconds`() {
    ...
    classUnderTest.nextDepositEpochMillis shouldEqualTo 1546387200000 // milliseconds in a day
  }
  ...
  companion object {
    ...
    fun nextDepositeDayProvider(): Stream<Arguments> {
      return Stream.of(
          arguments(daily, 1, LocalDate.of(1970, JANUARY, 1), LocalDate.of(1970, JANUARY, 2).atStartOfDay(ZoneOffset.UTC)),
          arguments(weekly, 4, LocalDate.of(1970, JANUARY, 1), LocalDate.of(1970, JANUARY, 8).atStartOfDay(ZoneOffset.UTC)),
          arguments(weekly, 1, LocalDate.of(1970, JANUARY, 1), LocalDate.of(1970, JANUARY, 5).atStartOfDay(ZoneOffset.UTC)),
          arguments(weekly, 6, LocalDate.of(1970, JANUARY, 1), LocalDate.of(1970, JANUARY, 3).atStartOfDay(ZoneOffset.UTC)),
          arguments(monthly, 1, LocalDate.of(1970, JANUARY, 1), LocalDate.of(1970, FEBRUARY, 1).atStartOfDay(ZoneOffset.UTC)),
          arguments(monthly, 5, LocalDate.of(1970, JANUARY, 4), LocalDate.of(1970, JANUARY, 5).atStartOfDay(ZoneOffset.UTC)),
          arguments(monthly, 5, LocalDate.of(1970, JANUARY, 10), LocalDate.of(1970, FEBRUARY, 5).atStartOfDay(ZoneOffset.UTC))
      )
    }
